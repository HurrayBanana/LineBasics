...
namespace Template
{
    ...
    public partial class GM
    {
        ...
        /// </summary>
        public static Rectangle screenSize = new Rectangle(0, 0, 1200, 970);
        /*************************************************
        ...
        *************************************************/
        ...
        public static Texture2D txFlag;//wilmington sheild.
        ...
        public void StartPreLoader()
        {
            ...
            GM.loadM.AddTexture(delegate (Texture2D t, string f) { txFlag = t; }, "wilmington sheild");
